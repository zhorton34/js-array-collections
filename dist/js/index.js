...
var ArrayCollection = function ArrayCollection(collection) {
  ...
  this.collection.orderBy = function (property) {
    var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'asc';

    if (context === 'asc') {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.sortBy(this, property);
    } else {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.sortBy(this, property).reverse();
    }
  };
  /**
   *  @param String
  ...
  this.collection.nested = function (string) {
    ...
    for (var iteration = 0, limit = split.length; iteration < limit; ++iteration) {
      var key = split[iteration];
  ...
  this.collection.nestedPluck = function (string) {
    ...
    return this.map(function (item, index) {
      return _this.nested("".concat(index, ".").concat(string));
    });
  };
  /**
   * @param {*}
  ...
  this.collection.doesNotIncludeProperty = function (property) {
    return this.reduce(function (carry, item) {
      return _toConsumableArray(Object.keys(item));
    }, []).includes(property) === false;
  };
  /**
   * @return Boolean
   */
  ...
  this.collection.whereHas = function (property, callback) {
    return this.map(function (item) {
      return callback(item[property]) ? item : null;
    }).removeNull();
  };
  /**
  ...
  this.collection.when = function () {
    var subset = this.where.apply(this, arguments);
  ...
  this.collection.otherwise = function (callback) {
    ...
    var _this$whenThenOtherwi = this.whenThenOtherwise,
        when = _this$whenThenOtherwi.when,
        then = _this$whenThenOtherwi.then,
        otherwise = _this$whenThenOtherwi.otherwise;
    this.whenThenOtherwise;
    return this.map(function (item) {
      return when.contains(item) ? then(item) : otherwise(item);
    });
  };
  /**
   *
  ...
  this.collection.mapWhereHas = function (conditionalCallback, mapperCallback) {
    return this.map(function (item) {
      return conditionalCallback(item) ? mapperCallback(item) : _objectSpread({}, item);
    }).removeNull();
  };
  /*
  ...
  this.collection.updateWhere = function () {
    for (var _len = arguments.length, options = new Array(_len), _key = 0; _key < _len; _key++) {
      options[_key] = arguments[_key];
    }

    var updateCallback = options[options.length - 1];
    var whereConditions = options.slice(0, options.length - 1);

    var subset = _toConsumableArray(this);

    subset = whereConditions.length === 2 ? subset.where(whereConditions[0], whereConditions[1]) : subset.where(whereConditions[0], whereConditions[1], whereConditions[2]);
    return this.reduce(function (carry, item) {
      return [].concat(_toConsumableArray(carry), [subset.contains(item) ? updateCallback(item) : item]);
    }, []);
  };
  /**
   * @return Boolean
  ...
  this.collection.contains = function (item) {
    return this.reduce(function (foundMatch, compareAgainst) {
      return foundMatch ? true : lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isEqual(item, compareAgainst);
    }, false);
  };
  /**
   * @return Array
  ...
  this.collection.wherePropertyHas = function (property, has) {
    return this.whereHas(property, function (item) {
      return item.includes(has);
    });
  };
  /**
   *
  ...
  this.collection.whereIn = function (property, array) {
    ...
    this.forEach(function (element) {
      if (array.includes(element[property])) subset.push(element);
    });
    return subset;
  };
  /**
  ...
  this.collection.groupBy = function (property) {
    ...
    var set = [];
    var groups = this.pluck(property).unique();
    groups.forEach(function (group) {
      set[group] = _this2.where(property, '=', group);
    });
    return set;
  };
  /**
  ...
  this.collection.findOrFail = function ($property, $condition, $expectation) {
    var subset = this.where($property, $condition, $expectation);
  ...
  this.collection.each = function (callback) {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.forEach(this, callback);
  };
  /**
   *
   * @returns {Array}
  ...
  this.collection.tail = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.tail(this);
  };
  /**
   *
   * @param number
  ...
  this.collection.where = function () {
    ...
    var $condition = options[1];
    var $expectation = options[2];
    var subset = [];
    var conditions = ['=', '!=', '<=', '>=', '<', '>', '!'];
    ...
    if (options[0].constructor !== Array) {
      ...
      this.forEach(function (prop) {
        if ($condition.includes('!') && $condition.includes('=')) {
          if (prop[$property] !== $expectation) subset.push(prop);
  ...
  this.collection.pluck = function (prop) {
    return this.reduce(function (items, item) {
      return [].concat(_toConsumableArray(items), [item[prop]]);
    }, []);
  };
  /**
   *
  ...
  this.collection.unique = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.uniq(this);
  };
  /**
   *
   * @param args
  ...
  this.collection.append = function () {
    ...
    this.push.apply(this, _toConsumableArray(args));
    return this;
  };
  /**
   *
  ...
  this.collection.count = function () {
    var number = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
    if (number !== undefined) return this.length === number;
    return this.length;
  };
  /**
   *
  ...
  this.collection.chunk = function (by) {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.chunk(this, by);
  };
  /**
   *
   * @param $property
  ...
  this.collection.intersect = function (array) {
    try {
      if (array.length > this.length) return array.filter(function (element) {});else return null;
    } catch (error) {
  ...
  this.collection.prepend = function () {
    ...
    this.unshift.apply(this, _toConsumableArray(args));
  };
...
__webpack_require__(/*! ./collections.js */ "./src/collections.js");

__webpack_require__(/*! ./numbers.js */ "./src/numbers.js");

__webpack_require__(/*! ./strings.js */ "./src/strings.js");
...
var Numberify = function Numberify(number) {
  _classCallCheck(this, Numberify);
  ...
  this.number.isFirstIn = function () {
  ...
  this.number.isItemOneIn = function () {
    var array = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
var Stringify = function Stringify(string) {
  ...
  this.string.isDate = function () {
    var expression = /(^\d{1,4}[\.|\\/|-]\d{1,2}[\.|\\/|-]\d{1,4})(\s*(?:0?[1-9]:[0-5]|1(?=[012])\d:[0-5])\d\s*[ap]m)?$/;
    if (toString.call(this) === '[object Date]') return true;
    if (typeof this.replace === 'function') this.replace(/^\s+|\s+$/gm, '');
  ...
  this.string.snakeCase = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.snakeCase(this);
  };
  /**
   * @return String
   */
  ...
  this.string.textCase = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.capitalize(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.lowerCase(this));
  };
  /**
   * @return String
   */
  ...
  this.string.camelCase = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.camelCase(this);
  };
  /**
   * @return String
   */
  ...
  this.string.kebabCase = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.kebabCase(this);
  };
  /**
   * @return String
   */
  ...
  this.string.titleCase = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startCase(this);
  };
  /**
   * @return String
   */
  ...
  this.string.capitalize = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.capitalize(this);
  };
  /**
   * @return String
   */
  ...
  this.string.toUpper = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.toUpper(this);
  };
  /*
  ...
  this.string.repeat = function (manyTimes) {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.repeat(this, manyTimes);
  };
  /**
   * @param Number
   * @param Boolean
  ...
  this.string.truncate = function (limit) {
    var dots = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    var truncated = this.substring(0, limit);
  ...
  this.string.parseInt = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.parseInt(this);
  };
  /**
   * @return String
   */
  ...
  this.string.startsWith = function () {
    var startsWith = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var startingPosition = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startsWith(this, startsWith, startingPosition);
  };
  /**
   * @return String
   */
  ...
  this.string.endsWith = function () {
    var endsWith = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var startingPosition = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.endsWith(this, endsWith, startingPosition);
  };
  /*
   * @return String
   * Find and replace
  ...
  this.string.replace = function () {
    var find = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var replace = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.replace(this, find, replace);
  };
  /*
   * @return String
  ...
  this.string.trim = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.trim(this);
  };
  /*
   * @return String
   * Trim end
  ...
  this.string.trimEnd = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.trimEnd(this);
  };
  /*
  * @return String
  * Trim start
  */
  ...
  this.string.trimStart = function () {
    return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.trimStart(this);
  };
};
...
module.exports = __webpack_require__(/*! /Users/zhorton/repos/js-array-collections/src/index.js */"./src/index.js");
